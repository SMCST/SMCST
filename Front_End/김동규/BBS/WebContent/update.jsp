...
<body>
	...
	<div class="container">
		<div class="row">
		<form method="post" action="updateAction.jsp?bbsBoardNumber=<%= bbsBoardNumber %>">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						<td><textarea class="form-control" placeholder="글 내용" name="bbsContents" maxlength="1000" style="height: 350px; resize: none;"><%= bbs.getBbsContents() %></textarea></td>
					</tr>
				</tbody>
			</table>
